...
namespace DogKennel_Project.Controllers
{
    public class SizesController : Controller
    {
        ...
        public SizesController(DogKennel_ProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Size_Name,Shedding_Name")] Size size)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Size_Name,Shedding_Name")] Size size)
        {
            if (id != size.Id)
            {
                return NotFound();
